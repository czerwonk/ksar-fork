...
public class paging1Sar extends AllGraph {
    ...
    public paging1Sar(final kSar hissar) {
        super(hissar);
        Title = "Paging1";
        t_pgfree = new TimeSeries("pgfree/s", org.jfree.data.time.Second.class);
        mysar.dispo.put("Page free/s", t_pgfree);
    ...
    public void addtotree(final DefaultMutableTreeNode myroot) {
        mynode = new DefaultMutableTreeNode(new GraphDescription(this, "SOLARISPAGING1", this.Title, null));
