...
public class bufferSar extends AllGraph {
    ...
    public void addtotree(final DefaultMutableTreeNode myroot) {
        mynode = new DefaultMutableTreeNode(new GraphDescription(this, "ESARBUFFER", this.Title, null));
