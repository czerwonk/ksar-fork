...
public class nfsdv2Sar extends AllGraph {
    ...
    public void addtotree(final DefaultMutableTreeNode myroot) {
        mynode = new DefaultMutableTreeNode(new GraphDescription(this, "ESARNFSDV2", this.Title, null));
