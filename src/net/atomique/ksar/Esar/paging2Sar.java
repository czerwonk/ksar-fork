...
public class paging2Sar extends AllGraph {
    ...
    public void addtotree(final DefaultMutableTreeNode myroot) {
        mynode = new DefaultMutableTreeNode(new GraphDescription(this, "ESARPAGING2", this.Title, null));
