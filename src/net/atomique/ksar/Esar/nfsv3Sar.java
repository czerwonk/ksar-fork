...
public class nfsv3Sar extends AllGraph {
    ...
    public void addtotree(final DefaultMutableTreeNode myroot) {
        mynode = new DefaultMutableTreeNode(new GraphDescription(this, "ESARNFSV3", this.Title, null));
