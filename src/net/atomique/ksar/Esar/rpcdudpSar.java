...
public class rpcdudpSar extends AllGraph {
    ...
    public void addtotree(final DefaultMutableTreeNode myroot) {
        mynode = new DefaultMutableTreeNode(new GraphDescription(this, "ESARRPCDUDP", this.Title, null));
