...
public class rpcudpSar extends AllGraph {
    ...
    public rpcudpSar(final kSar hissar) {
        ...
        misc_collection.addSeries(this.t_retrans);
        misc_collection.addSeries(this.t_cantsend);
    ...
    public void add(final Second now,final Float val1,final Float val2,final Float val3,final Float val4,final Float val5,
        ...
        this.t_cantsend.add(now, val5, do_notify());
        this.t_retrans.add(now, val6, do_notify());
    ...
    private final TimeSeries t_cantsend;
    private final TimeSeries t_retrans;
